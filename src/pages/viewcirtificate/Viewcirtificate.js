            ...
            <div ref={ref}>
              <Col span={24}>
                ...
                <div className="view_cirtificate_head">
                  ...
                  <div className="view_cirtificate_text">
                    ...
                    <Title level={5} className="mt_0 mb_0 lh_1 text_primary">
              ...
              <Col span={24} className="mt_5 text_justify">
                <Text className="text_justify">
                  ...
                  common trust and confidence with precision, disclosing the
                  identity and authenticity of the product specimen without
                  legal bindings, as Gemstones of similar appearance can have
                  specific different values which can be modified and enhanced
                  at any time. NGL can re assess whether the product specimen in
                  accordance with the report based on the analysis and
                  interpreting the characters of setting permit with limits. The
                  authenticity of colour and nature of additional precious
                  stones in the setting have NOT been tested, and the specified
                  weight indicated herein is with an approximate measure and may
                  differ once scale is reset. The validation of the Test Report
                  stands good only if appended with an authorized signatory,
                  embossed stamp and Trade Mark label on the surface laminated.
                  The Laboratory Report may also be verified on{" "}
                  <Link
                  ...
                  . The PDF coloured scanned and facsimile copies of the Report
                  at any circumstances are NOT valid and legally bind to whom so
                  ever may concern. Further details may be seen in the Terms and
                  Conditions of the Lab enumerated in overleaf. This Test Report
                  is the Copyright of the National Gem Lab Chennai, India.
                </Text>
              </Col>
